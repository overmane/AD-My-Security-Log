...
An interesting share named Enterprise-Share is found. Inside, there is a PowerShell script: PurgeIrrelevantData_1826.ps1.
...
Since our user has write access to this share, we can replace the script with a Nishang reverse shell:  
...
We upload a PrintNightmare exploit (CVE-2021-1675.ps1) to the target:  
